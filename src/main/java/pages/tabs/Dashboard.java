...
import pages.Portal;
import pages.modals.DocumentModal;
import pages.modals.EventModal;
import pages.modals.NotesModal;
import pages.modals.WorkflowModal;
...
public class Dashboard extends Portal {
    ...
    protected WebElement buttonViewFullCalendar(){
